...
class View
{
    ...
    public function __construct($engine = [], $replace = [])
    {
        ...
        $baseReplace = [
            ...
            '__CSS__'    => $root.'/public/'.$request->module().'/css',
            '__IMAGES__' => $root.'/public/'.$request->module().'/images',
            '__VIDEOS__' => $root.'/public/'.$request->module().'/videos',
            '__JS__'     =>$root.'/public/'.$request->module().'/js',
