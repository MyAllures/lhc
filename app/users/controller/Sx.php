...
class Sx extends Common{
    public function index(){
        ...
        //不同
        $res_bl=Db::name('bl')->where(['class1'=>'生肖'])->field('distinct(class2)')->select();
...
//        }
        ...
        $wh=array_merge($vvvv,['class1'=>$class1,'class2'=>$class2,'kithe'=>$kithe,'class3'=>['not in',['单','双','大','小','合单','合双','红波','蓝波','绿波','野兽','家禽']]]);
        ...
        foreach ($result as $v){
            ...
            if($class2=="特肖"||$class2=="一肖" ){
                ...
                $r1=Db::query("Select * from ka_bl  where   class1='".$v['class1']."' and class2='".$v['class2']."' and (".$t_sql.")");
                $Rsbl=$r1[0];
            }
