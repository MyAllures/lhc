<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\www\PHPTutorial\WWW\lhc/app/index\view\zm\index.html";i:1548643698;s:57:"D:\www\PHPTutorial\WWW\lhc\app\index\view\public\top.html";i:1547431222;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="layui-crad">
                    ...
                    <div class="layui-card-header">
                        ...
                        <div style="float: right;" class="layui-btn-group">
                            <button onclick="javascript:location.href='<?php echo url('index'); ?>?ids=正A';return false;" class="layui-btn layui-btn-sm"><span>正A</span></button>&nbsp;
                        </div>
                    </div>
                    <div class="layui-card-body">
                        <table class="layui-table">
                            ...
                            <tbody>
                            <?php $__FOR_START_26459__=1;$__FOR_END_26459__=11;for($i=$__FOR_START_26459__;$i < $__FOR_END_26459__;$i+=1){ ?>
                            <tr>
                                <?php if($i == 10): ?>
