<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"D:\www\PHPTutorial\WWW\lhc/app/users\view\index\index.html";i:1548474397;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body class="layui-layout-body">
  <div id="LAY_app">
    <div class="layui-layout layui-layout-admin">
      <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
          <li class="layui-nav-item layadmin-flexible" lay-unselect>
            <a href="javascript;void();" style="font-size:26px;font-weight: bold;"><?php echo $webname; ?></a>
          </li>
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <?php if($admin['vip'] == 0): ?>  <!--子账户不能访问 start-->
            <?php if($admin['lx'] == 4): ?>
            <li class="layui-nav-item layui-hide-xs" lay-unselect>
              <a lay-href="<?php echo url('dagu/index'); ?>" layadmin-event="message" lay-text="股东">股东</a>
            </li>
            <?php endif; if($admin['lx'] == 1 || $admin['lx'] == 4): ?>
            <li class="layui-nav-item layui-hide-xs" lay-unselect>
              <a lay-href="<?php echo url('zong/index'); ?>" layadmin-event="message" lay-text="总代理">总代理</a>
            </li>
            <?php endif; if($admin['lx'] <= 2 || $admin['lx'] == 4): ?>
            <li class="layui-nav-item layui-hide-xs" lay-unselect>
          ...
          <li class="layui-nav-item layui-hide-xs" lay-unselect>
            <a lay-href="<?php if($admin['lx'] == 4): ?><?php echo url('zhudan/daGu'); elseif($admin['lx'] == 1): ?><?php echo url('zhudan/index'); elseif($admin['lx'] == 2): ?><?php echo url('zhudan/index2',['username'=>$admin['kauser']]); else: ?><?php echo url('zhudan/index3',['username'=>$admin['kauser']]); endif; ?>" layadmin-event="message" lay-text="注单查询">注单查询</a>
          </li>

          <?php if($admin['lx'] == 1 || $admin['lx'] == 4): ?>
          <li class="layui-nav-item layui-hide-xs" lay-unselect>
          ...
          <li class="layui-nav-item" lay-unselect>
            <a href="javascript:;">
              <cite><?php echo $ch; ?>【<span style="color: red;font-weight: bold;"><?php echo $admin['kauser']; ?></span>】</cite>
            </a>
            <dl class="layui-nav-child">
              <?php if($admin['vip'] == 0): ?> <dd style="text-align: center;"><a lay-href="<?php echo url("guan/savepass"); ?>">修改密码</a></dd>  <hr><?php endif; ?>
      ...
      <!-- 关于 -->
      <div id="is-about-set" class="layui-hide">
      ...
      <div class="layui-side layui-side-menu layui-hide">
        <div class="layui-side-scroll">
          <div class="layui-logo">
            <span id="webname" style="font-size: 30px;"><?php echo getConfigField('webname'); ?></span>
          </div>
